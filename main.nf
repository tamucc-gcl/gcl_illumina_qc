...
params.blast_db = "/work/birdlab/databases/midori2_latest/midori2_latest"  // Path to local BLAST database (null = use NCBI nt)
params.taxonomy_db "/work/birdlab/databases/ncbi_taxonomy"
